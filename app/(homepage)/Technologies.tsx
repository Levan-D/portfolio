...
export default function Technologies() {
  ...
  return (
    <div ref={ref} id="technologies" className="mt-20  md:mt-48 md:min-h-screen">
      <div
        className={` ${
          isVisible
            ? " md:translate-x-0 md:opacity-100"
            : "md:translate-x-[800px] md:opacity-0"
        } mx-auto w-fit max-w-sm py-20 text-center duration-500`}
      >
      ...
      >
        <Card sideLine={true} customCSS=" mx-auto  !h-fit !w-fit   ">
          <div className=" flex  max-w-xl select-none flex-wrap justify-center gap-6  rounded-xl px-0 py-10 md:px-6 lg:max-w-3xl lg:px-12 lg:py-20  xl:max-w-5xl ">
            {techObj.map(item => (
              <a key={uuidv4()} href={item.url} target="_blank" rel="noopener noreferrer">
