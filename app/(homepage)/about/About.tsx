  ...
  return (
    <div id="about" className="  flex md:h-[calc(100vh-88px)] flex-col justify-between  ">
      <div className="pt-36   text-center md:ml-10 md:pt-[20vh] md:text-left">
        <p className="font-semibold textSecondary lg:text-xl">Hey! my name is</p>
        <p className="mt-2 text-2xl font-bold md:text-4xl lg:mt-4  lg:text-5xl xl:text-6xl ">
          Levan Dolidze.
        </p>
        <p className=" mt-2 text-2xl font-bold textTertiary md:text-4xl lg:mt-4 lg:text-5xl xl:text-6xl">
          I’m a Web Developer.
        </p>
        <p className=" mx-auto mt-2 max-w-[600px] font-bold textTertiary  md:mx-0  lg:mt-4  lg:max-w-[700px]  lg:text-xl">
